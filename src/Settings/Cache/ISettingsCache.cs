...
namespace Phoenix.Functionality.Settings.Cache
{
	...
	public interface ISettingsCache
	{
		...
		///// <summary>
		///// Gets the settings of type <typeparamref name="TSettings"/>.
		///// </summary>
		///// <typeparam name="TSettings"> The concrete settings type. </typeparam>
		///// <param name="settings"> The settings instance. </param>
		///// <returns> The settings instance or <c>Null</c>. </returns>
		//TSettings Get<TSettings>(out TSettings settings) where TSettings : ISettings;
		...
		bool TryGet<TSettings>(out TSettings settings) where TSettings : ISettings;
		...
		/// <typeparam name="TSettings"> The concrete settings type. </typeparam>
		/// <param name="settings"> The settings instance. </param>
		void AddOrUpdate<TSettings>(TSettings settings) where TSettings : ISettings;
		...
		/// <returns> <c>True</c> if the settings where retrieved from cache, otherwise <c>False</c>. </returns>
		bool TryGetOrAdd<TSettings>(out TSettings settings, Func<TSettings> factory) where TSettings : ISettings;
	}
}