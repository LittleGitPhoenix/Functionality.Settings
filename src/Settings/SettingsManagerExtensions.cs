...
public static class SettingsManagerExtensions
{
	...
	public static string GetSettingsName<TSettings>(this ISettingsManager settingsManager) where TSettings : ISettings
		=> settingsManager.GetSettingsName(typeof(TSettings));
	...
	/// <returns> The name of the settings class. </returns>
	public static string GetSettingsName(this ISettingsManager settingsManager, Type settingsType)
	{
